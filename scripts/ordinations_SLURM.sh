...
#SBATCH --output="/work/adina/bolivar/interbrc-core-analysis/hpc/slurm-%j-007_ordinations_full.out"   # Job standard output file (%j will be replaced by the slurm job id)
#SBATCH --error="/work/adina/bolivar/interbrc-core-analysis/hpc/slurm-%j-007_ordinations_full.error"   # Job standard error file (%j will be replaced by the slurm job id)
