...
all_asv_nmds_pcoa_plots <- brc_paper_ordinations(
  ...
  brc_theme = list(ggtitle("All ASVs across BRCs"), brc_theme_title_size())
)
...
#-------------------------------------------------------
# FIXED: Removed syntax errors from original script (lines 408-411)
...
#-------------------------------------------------------
# FIXED: Removed syntax errors from original script (lines 486-489)
