...
for (sample_reads in min_sample_reads_thresholds) {
    for (asv_reads in min_asv_reads_thresholds) {
        ...
        result_name <- paste0("sample_reads_", sample_reads, "_asv_reads_", asv_reads)
...
save(filtered_asv_matrices, file = here::here("data/output/filtered_asv_matrices.rda"))
...
save(hell_matrices_filtered, file = here::here("data/output/hell_matrices_filtered.rda"))
